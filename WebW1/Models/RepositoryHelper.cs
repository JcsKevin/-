namespace WebW1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料統計Repository Get客戶資料統計Repository()
		{
			var repository = new 客戶資料統計Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料統計Repository Get客戶資料統計Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料統計Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
